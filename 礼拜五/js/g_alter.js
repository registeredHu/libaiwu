/*
* @Author: name
* @Date:   2018-02-05 10:53:29
* @Last Modified by:   name
* @Last Modified time: 2018-02-08 14:55:23
*/
$(function(){
    // 获取input框的值
    ...
    $(".g_save a:eq(0)").click(function(){
        $(".g_alt").css("display","none");
        $(".g_alt_box").css("display","none");
    })
    $(".use_newadd").click(function(){
        $(".g_alt").css("display","block");
        $(".g_alt_box").css("display","block");
    });
